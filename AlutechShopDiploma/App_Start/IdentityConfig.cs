...
namespace AlutechShopDiploma
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            var from = "yansleptsov4@gmail.com";
            var pass = "SLEPTSOVYAN1999";
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            string AccountSid = "AC03679345c33232a432c4ce9decf6033f";

            string AuthToken = "a27c6e9f201f928df87af1ce192597e7";

            string phoneNumberFrom = "+15005550006";

            TwilioClient.Init(AccountSid, AuthToken);

            var messageToSend = MessageResource.Create(from: new PhoneNumber(phoneNumberFrom),
